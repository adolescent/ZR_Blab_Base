...
# np.savez_compressed(r'E:\#Preprocessed_Data\GoodUnits\251108_ZhuangZhuang_Metamer_Singlebubble_v251107_4540_g2_MSB',psth = psth)
psth = np.load(r'E:\#Preprocessed_Data\GoodUnits\251108_ZhuangZhuang_Metamer_Singlebubble_v251107_4540_g2_MSB.npz')['psth']
...
N_sub = 12
fig,ax = plt.subplots(ncols=1,nrows=1,dpi=240,figsize=(3,4))
...
# ax.plot([1599,1599],[0,100],c='r',zorder=10,linewidth=1)
# ax.set_yticks([])
...
bubble_resp_mask = np.zeros(shape = (100,20,400,400),dtype='f8')
for i in tqdm(range(100)): # cycle cell
...
savepath=r'E:\#Coding_traces\251125_Bubbles\MSB_Bubble_RF'
#%% save cells
thres = 2.5
for i in tqdm(range(100)): #cycle cell
    for j in range(20):
...
savepath=r'E:\#Coding_traces\251125_Bubbles\MSB_Rest_RF'
...
sns.heatmap(ac_response,center=0,vmax=0.017,ax=ax,cbar=False,cmap='bwr',xticklabels=False,yticklabels=False)
