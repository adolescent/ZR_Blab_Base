...
for i,cloc in tqdm(enumerate(msb_sites)):
    ...
    # raw_rsp = a.avr_psth
    if stimeset == 'Metamer_Cut_v251011':
        metamer_cutshuffle = body_resps[:,300:,:] # keep all except for fob.

    elif stimeset == 'Mega_Metamer_v251104': # remove cut-shuffle parts, keep cut only.
        # metamer_cutshuffle = body_resps[:,300:2240,:]
        metamer_cutshuffle = body_resps[:, np.r_[300:1300, 1400:1440, 2240:3680], :]
