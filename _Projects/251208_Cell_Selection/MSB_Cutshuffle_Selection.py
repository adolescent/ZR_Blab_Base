...
for i,cloc in tqdm(enumerate(msb_sites)):
    ...
    if stimeset!='Mega_Metamer_v250920' and stimeset!='Mega_Metamer_v251104':
        continue
    ...
    # raw_rsp = a.avr_psth
    if stimeset == 'Mega_Metamer_v250920':
        metamer_cutshuffle = body_resps[:,300:,:]
    elif stimeset == 'Mega_Metamer_v251104':
...
#%% save all msb cells
np.savez_compressed(ot.Join(savepath,'MSB_Cells_Metamer_Cutshuffle.npz'),psth = all_matemer_resp,d_primes = all_d_primes,response = all_response)
