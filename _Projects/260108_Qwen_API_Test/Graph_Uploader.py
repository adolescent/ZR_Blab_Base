'''
这个脚本根据需求上传图片到url,用于后续处理。

教程：
https://help.aliyun.com/zh/model-studio/get-temporary-file-url?spm=a2c4g.11186623.help-menu-2400256.d_2_15_5.719f3ee2qsdm14&scm=20140722.H_2869454._.OR_help-T_cn~zh-V_1
...
if __name__ == "__main__":
    ...
    # 待上传的文件路径
    file_path = r"E:\#Stimsets\Silct\silct_npx_1416\0265.jpg"  # 替换为实际文件路径
...
#%% 调用的示例
    ...
    # print(response)
    print(response.output.choices[0].message.content[0]['text']) # 描述文档