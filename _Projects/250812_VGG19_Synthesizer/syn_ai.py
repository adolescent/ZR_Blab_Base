...
if __name__ == "__main__":
    # 加载目标图像
    target_image = Image.open("0004.jpg").convert("RGB")
    ...
    synthesizer_global = FeatureSynthesizer(
        target_image, 
        spatial_constraint=(1,1),  # 全局约束 (完全打乱)
        feature_layers=['pool1','conv4_2'],
        num_steps=5000,step_mute=False
    )
    # 似乎必须保留内容层，使用pool3的效果最好
