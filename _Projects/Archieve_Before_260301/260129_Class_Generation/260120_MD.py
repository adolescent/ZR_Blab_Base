...
#%%
gn_folder = r'E:\#Preprocessed_Data\GoodUnits\nsd'
c_gn_path = 'GoodUnit_260207_MaoDan_NSD1000_g5_MSB_ML.mat'
c_gn_path = ot.Join(gn_folder,c_gn_path)
SRS = Single_Recording_Site(gn_path=c_gn_path,
                            stimset='NSD_1k',
                            brain_areas=['MSB','ML'],
...
gn_folder = r'E:\#Preprocessed_Data\GoodUnits\metamer'
c_gn_path = 'GoodUnit_260210_MaoDan_Metamer_Singlebubble_v251107_4540_g3_MSB_ML.mat'
c_gn_path = ot.Join(gn_folder,c_gn_path)
SRS = Single_Recording_Site(gn_path=c_gn_path,
...
gn_folder = r'E:\#Preprocessed_Data\GoodUnits\silct_new'
c_gn_path = 'GoodUnit_260210_MaoDan_Doodle_AI_v260121_g5_MSB_ML.mat'
c_gn_path = ot.Join(gn_folder,c_gn_path)
SRS = Single_Recording_Site(gn_path=c_gn_path,
                            stimset='Doodle_v260121',
                            brain_areas=['MSB','ML'],
