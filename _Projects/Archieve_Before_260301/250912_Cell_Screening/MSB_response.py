...
ceiled_files = ot.Get_File_Name(r'D:\#Data\Metamer\ceiled_response\MSB','.pkl')
...
#%% save msb response.
ot.Save_Variable(r'D:\#Data\Metamer\ceiled_response\MSB','Sorted_Response',(body_dp_sorted,redplot,sorted_psth))
